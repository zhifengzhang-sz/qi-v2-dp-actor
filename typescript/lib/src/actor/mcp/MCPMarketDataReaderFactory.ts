...
export class MCPMarketDataReaderFactory {
   ...
   */
  static createLocalServerReader(
    context: DSL.DataContext,
    port = 8080
  ): MCPMarketDataReader {
    const mcpConfig: MCPConnectionConfig = {
...
export const createWebSocketStreamingReader = MCPMarketDataReaderFactory.createWebSocketStreamingReader;